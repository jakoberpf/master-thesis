...
\subsubsection{Significance}
The significancy evaluation of Kendall's $\tau$ coefficient is done via the 2-tailed $p$-value, elaborated in section \ref{correlation_pearson}.
...
TODO Theil’s U definition explanation
