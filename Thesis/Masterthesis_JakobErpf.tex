...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4, trim=2cm 6cm 0cm 6cm]{../CorrAnalysis/data/BAYSIS/03_selected_01_startJam/plots/baysis_matched_corr_cramers}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4, trim=2cm 6cm 0cm 6cm]{../CorrAnalysis/data/BAYSIS/03_selected_01_startJam/plots/baysis_matched_corr_theils}
...
\setlength{\tabcolsep}{2pt}
\centering
\include{../CorrAnalysis/data/BAYSIS/03_selected_01_startJam/latex/baysis_matched_corr_cramers}
\caption{Correlation matrix for BAYSIS selected data (Jam Initiator), with Cramer's $V$}
...
\setlength{\tabcolsep}{2pt}
\centering
\include{../CorrAnalysis/data/BAYSIS/03_selected_01_startJam/latex/baysis_matched_corr_theils}
\caption{Correlation matrix for BAYSIS selected data (Jam Initiator), with Theil's $U$}
\end{sidewaystable} % <-- HERE
...
\setlength{\tabcolsep}{2pt}
\centering
\include{../CorrAnalysis/data/BAYSIS/03_selected_01_startJam/latex/baysis_matched_sign_cramers}
...
\setlength{\tabcolsep}{2pt}
\centering
\include{../CorrAnalysis/data/BAYSIS/03_selected_01_startJam/latex/baysis_matched_coef_theils}
\caption{Significancy matrix for BAYSIS selected data (Jam Initiator)}
\end{sidewaystable} % <-- HERE
\restoregeometry
