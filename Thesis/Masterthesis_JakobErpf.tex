...
Pearson $r$ desrcibes the linear correlation of continuous, non-ranked variables. It does not assume normality or a normal distributed sample set and is therefore suitable for the examination of continuous-continuous variable relations, where we can assume finite size of variance and covariance \cite{BenestyChenHuang2009, Sulthan2018}. 
...
Because the provided (see \ref{dataset_baysis} and \ref{dataset_arbis}) and generated (see \ref{methodology_data_generation}) datasets also include categorical variables, describing nominal, dichotomous and ordinal characteristics, other correlation methods are needed. The Point Biserial correlation, a special form of the Pearson correlation coefficient, is able to evaluate the association of continuous-dichotomous relations. 
