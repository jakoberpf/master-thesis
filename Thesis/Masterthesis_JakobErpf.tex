...
\newglossaryentry{jams}
{
        name=jam,
        description={or jams are spatial and timely accumulations of traffic participants, which leads to a reduction of travel speed and therefore reduction of traffic throughput. A more detailed definition can be found in chapter \ref{definition_congestion}}
}
\newglossaryentry{congestion}
{
        name=congestion,
        description={ or multiple congestion, here called jams, are spatial and timely accumulations of traffic participants, which leads to a reduction of travel speed and therefore reduction of traffic throughput. A more detailed definition can be found in chapter \ref{definition_congestion}}
}
...
\par In the following formula, showing the definition of each correlation coefficient, $x$ and $y$ are two vectors of length $n$. $m_x$ and $m_y$ corresponds to the means of vector $x$ and $y$, respectively.
