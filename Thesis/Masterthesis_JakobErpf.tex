...
\begin{figure}[h]
	\centering
	\includegraphics{../CorrAnalysis/data/BAYSIS/01_dataset/plots/baysis_dataset_count_multiple01}
...
\begin{figure}[h]
	\centering
	\includegraphics{../CorrAnalysis/data/BAYSIS/01_dataset/plots/baysis_dataset_count_multiple02}
	\caption{Distribution of the accident category 'Kat'}
	\label{img:appendix_baysis_dataset_Kat}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics{../CorrAnalysis/data/BAYSIS/01_dataset/plots/baysis_dataset_count_multiple03}
	\caption{Distribution of the accident category 'Kat'}
	\label{img:appendix_baysis_dataset_Kat}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics{../CorrAnalysis/data/BAYSIS/01_dataset/plots/baysis_dataset_count_multiple04}
	\caption{Distribution of the accident category 'Kat'}
	\label{img:appendix_baysis_dataset_Kat}
\end{figure}
