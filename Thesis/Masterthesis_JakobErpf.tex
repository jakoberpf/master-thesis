...
To exclude single cell error and exclude jams, which are too small to have any effect and origin to be considered in the analysis, there are some other threshold to define.  
...
\begin{itemize}
	\item Spatial gap in-between congestion : $l_{min,gap} = 5000$ % cluster consolidation 
	\item Temporal gap in-between congestion : $t_{min,gap} = 6 min$ % cluster consolidation 
