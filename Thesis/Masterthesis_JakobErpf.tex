...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4, trim=2cm 6cm 0cm 6cm]{../CorrAnalysis/data/BAYSIS/03_selected_01_startJam/plots/baysis_selected_corr_cramers}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4, trim=2cm 6cm 0cm 6cm]{../CorrAnalysis/data/BAYSIS/03_selected_01_startJam/plots/baysis_selected_corr_theils}
...
% -----------------------------------------------
% ------- BAYSIS Selected - Jam Source -------
% -----------------------------------------------
\tocless\section{BAYSIS Selected Data - Jam Source}
