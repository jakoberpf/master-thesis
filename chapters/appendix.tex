\begin{appendices}
    ...
    \begin{sidewaystable}
    	...
    	\caption{Correlation matrix for BAYSIS selected data (Jam Follower), with Cramer's $V$}
    ...
    \begin{sidewaystable}
    	...
    	\caption{Correlation matrix for BAYSIS selected data (Jam Follower), with Theil's $U$}
    ...
    \begin{table}
        ...
        \label{table:appendix_arbis_correlation_matrix_dataset_cramers}
    \end{table}
    \begin{table}
        \setlength{\tabcolsep}{4pt}
        \centering
        ...
        \label{table:appendix_arbis_correlation_matrix_dataset_theils}
    \end{table}
    \begin{table}
        \setlength{\tabcolsep}{4pt}
        \centering
        ...
        \label{table:appendix_arbis_significancy_matrix_dataset}
    \end{table}
    \begin{table}
        \setlength{\tabcolsep}{4pt}
        \centering
        ...
        \label{table:appendix_arbis_coefficient_matrix_dataset}
    \end{table}
    % \restoregeometry
