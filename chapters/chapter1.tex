...
The thesis is based on the analysis of three datasets, which are associated a confidentiality agreement for the usage in this thesis and therefore can not be added to the appendix. To provide an complete picture of the data analysis and also additional information to interested reader mosts scripts, results and visual representations are available in a version controlled open source repository\footnote{https://github.com/jakoberpf/master-thesis}. The submitted versions of the thesis also contain the confidential code which can not be made publicly available.
