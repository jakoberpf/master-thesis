...
The values of Theil's $U$ show the predictability of the association, where the following rules for interpretation apply to the implementation \parencite{TheilsInt01,TheilsInt02,TheilsInt03}.
