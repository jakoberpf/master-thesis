...
\begin{table}[ht]
    ...
    \begin{tabular}{c|c|c|c|c}
        \toprule
						& Ordinal 			& Dichotomous 			&  Nominal		& Continuous			\\
		\midrule
		Ordinal			& Cramer’s $V$		& Cramer’s $V$			& Cramer’s $V$	& Kendall's $\tau$		\\
		\midrule
		Dichotomous		& Cramer’s $V$		& Cramer’s $V$			& Cramer’s $V$	& Point Biserial $r$	\\
		\midrule
		Nominal			& Cramer’s $V$		& Cramer’s $V$			& Cramer’s $V$	& Eta $\eta$			\\
		\midrule
		Continuous		& Kendall's $\tau$ 	& Point Biserial $r$	& Eta $\eta$	& Pearson's $r$			\\
		\bottomrule
	\end{tabular}
