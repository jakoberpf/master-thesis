...
\begin{figure}[ht]
	...
	\end{tabular}
    \captionlistentry[table]{Distribution and encoding of accident variable \textbf{Kat}}
...
\begin{figure}[ht]
    ...
    \begin{tabular}[b]{c|l}
	  ...
	  7 & Other  \\
	\end{tabular}
    \captionlistentry[table]{Distribution and encoding of accident variable \textbf{Typ}}
    \captionsetup{labelformat=andtable}
...
\begin{figure}[ht]
	...
	\begin{tabular}[b]{c|l}
		...
		\bottomrule
	\end{tabular}
    \captionlistentry[table]{Distribution and encoding of accident variable \textbf{UArt}}
    \captionsetup{labelformat=andtable}
