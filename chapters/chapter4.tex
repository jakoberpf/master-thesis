...
\autoref{table:arbis_variables} shows all categorized parameters, relevant for the correlation analysis, with variable group, type and the format of the containing data.	
\begin{table}[!ht]
	\centering
	\begin{tabular}{c|c|c|c}
		\toprule
