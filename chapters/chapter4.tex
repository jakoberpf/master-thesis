...
The accident category (shown in \cref{tbl:descriptives_baysis_dataset_dist_Kat,fig:descriptives_baysis_dataset_dist_Kat} and visualized in \cref{img:baysis_dataset_Kat}), describes which damages or injuries can be associated with the accident. It ranges from accidents with just damaged property to lightly and heavily injured and even deathly accidents. The distribution develops from lowest to highest counts, in order of gravity of the category. The variable consists of four values, which can be ordered and is therefore ordinal.
\begin{table}[!ht]
	\centering
	\small
...
% 			\bottomrule
% 		\end{tabular}
% 		\subcaption[second caption.]{Table of all descriptives}\label{tbl:descriptives_baysis_dataset_dist_Kat}
% 	\end{minipage}%
...
% 			]
% 			\addplot table [absolute series=1] {\data};
% 			\legend{
% 				\textit{Kat}}
% 			\end{axis}
% 			\begin{axis}[
...
% 		\subcaption[second caption.]{Plot of \textit{AnzGesperrtFs} descriptives}\label{fig:descriptives_baysis_dataset_dist_Kat}
% 	\end{minipage}%
% 	\caption{Descriptives of \textit{Kat}}
% 	%\vspace{-8mm}
% \end{figure}
% % #### START: Table and Plot
\paragraph{Typ}
...
\begin{table}[ht]
	...
	\begin{tabular}{c|c|c|c|l}
		\toprule
		Code & Count[1] & Count[2] & [\%] & Description \\ 
		\midrule
...
% 			\midrule  
% 			% -1 & 3		& < 0.1 & Unknown \\
% 			0  & 215977	& 33.4  & zero lanes \\	 
% 			1  & 430022	& 66.5  & single lane \\	 
% 			2  & 140	& < 0.1 & two lanes \\	 
% 			3  & 81	 	& < 0.1 & three lanes \\
% 			\bottomrule
% 		\end{tabular}
% 		\subcaption[second caption.]{Table of all descriptives}\label{tbl:descriptives_arbis_dataset_dist_AnzGesperrtFs}
% 	\end{minipage}%
% 	\begin{minipage}{0.55\textwidth}
% 		\tiny
% 		\centering
...
% 			\end{axis}
% 		 \end{tikzpicture}\vfill
% 		\subcaption[second caption.]{Plot of \textit{AnzGesperrtFs} descriptives}\label{fig:descriptives_arbis_dataset_dist_AnzGesperrtFs}
% 	\end{minipage}%
% 	\caption{Descriptives of \textit{AnzGesperrtFs}}
% 	%\vspace{-8mm}
% \end{figure}
% % #### START: Table and Plot
