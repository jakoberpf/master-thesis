...
\begin{table}[ht!]
    ...
    \begin{tabular}{rrrrrrrrrr}
        ...
        \bottomrule
      \end{tabular}
    \caption{Pairwise Wilcoxon $T$-test for \textit{UArt1} and \textit{Temporal Distance} (Jam Initiator), see \cref{tbl:wilcoxon_baysis_initiator_UArt_TDist_complete} for complete table}
