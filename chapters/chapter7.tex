...
be interpreted that roadworks in October and December result in significantly longer spatial distances than the average. The roadwork jams in January, February and July tend to have significantly shorter spatial distances than the average.

that roadworks in September, October, November and December result in significantly denser jams than the average. The roadwork jams in March and July tend to be significantly less dense jams than the average.

\section{Predictability of accidents and jams}
Although in the introduction the goal was stated to improved the knowledge about the Predictability of accidents and jams, the time frame of the thesis didn't allow to finish the analysis. The correlation summary in the section before showed, that there are multiple accident characteristics, which correlate significantly with jams features. 
