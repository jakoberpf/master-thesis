...
encoded <- read_delim("data/BAYSIS/03_selected_01_startJam/csv/encoded.csv", ";", escape_double = FALSE, trim_ws = TRUE)
...
describeBy(encoded$SpatExMax,encoded$UArt1)
describeBy(encoded$SpatExMax,encoded$AufHi)
describeBy(encoded$SpatExMax,encoded$WoTag)
